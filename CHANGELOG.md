...
- **The proxy records every distinct request shape it sees** to `shapes.json`, so questions about which fields and beta headers Claude Code actually sends are answered by looking rather than guessing.
